node {
   ...
   parallel CxSAST_Scan: {
				...
				!**/*.stml,    !**/*.ttml,      !**/*.txn,      !**/*.xhtm,     !**/*.xhtml,   !**/*.class, !**/*.iml, !Checkmarx/Reports/*.*''', fullScanCycle: 10, groupId: '1', includeOpenSourceFolders: '', osaArchiveIncludePatterns: '*.zip, *.war, *.ear, *.tgz', osaInstallBeforeScan: false, password: '{AQAAABAAAAAQEg5tM7tusM3HsJQPjA1ftmtAIt6wOC/8B3Hxn5a1TdQ=}', preset: '36', projectName: 'Cx_Demo_BO', sastEnabled: true, serverUrl: 'http://localhost', sourceEncoding: '1', username: '', vulnerabilityThresholdResult: 'FAILURE', waitForResultsEnabled: true])
				}
			}, CxOSA_Scan: {
				stage('CxOSA') {
...
!**/*.hdml,    !**/*.hsql,      !**/*.ht,       !**/*.hta,      !**/*.htc,     !**/*.htd, !**/*.war, !**/*.ear,
!**/*.htmls,   !**/*.ihtml,     !**/*.mht,      !**/*.mhtm,     !**/*.mhtml,   !**/*.ssi, !**/*.stm,
!**/*.stml,    !**/*.ttml,      !**/*.txn,      !**/*.xhtm,     !**/*.xhtml,   !**/*.class, !**/*.iml, !Checkmarx/Reports/*.*''', fullScanCycle: 10, groupId: '1', password: '{AQAAABAAAAAQCqfCvlLaDlgfV8RBmv9c/wd/qg/JV78/jMyZPxTIG8Y=}', preset: '36', projectName: 'Cx_Demo_BO', sastEnabled: false, serverUrl: 'http://localhost', sourceEncoding: '1', username: '', vulnerabilityThresholdResult: 'FAILURE', waitForResultsEnabled: true])
				}
			}
			failFast: false
